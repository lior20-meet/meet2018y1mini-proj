...
def move_snake():
    ...
    # right edge.
    if new_x_pos+SQUARE_SIZE >= RIGHT_EDGE:
        print("You hit the right edge! Game over!")
        quit()

     # You should write code to check for the left, top, and bottom edges.
    #####WRITE YOUR CODE HERE
    elif new_x_pos- SQUARE_SIZE <= LEFT_EDGE:
        print("You hit the left edge! Game over!")
        quit()

    elif new_y_pos-SQUARE_SIZE <= DOWN_EDGE:
        print("You hit the down edge! Game over!")
        quit()

    elif new_y_pos+SQUARE_SIZE >= UP_EDGE:
    ...
    if snake.pos() in food_pos:
        ...
        print("food index:",food_ind)
        print("stamp id:",food_stamps[food_ind])
